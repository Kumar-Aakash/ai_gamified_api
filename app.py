...
offices = [
    {
        ...
        "facilities": ["Meeting rooms", "Cafeteria", "Parking", "24/7 Security", "High-speed elevators"],
    },
    {
        "id": 2,
        "name": "The Shard",
        ...
        "facilities": ["24/7 Security", "High-speed internet", "Gym", "Private meeting rooms", "Restaurant access"],
    },
    {
        "id": 3,
        ...
        "facilities": ["Conference halls", "Cafeteria", "Energy-efficient design", "Parking", "Panoramic city views"],
    },
    {
        "id": 4,
        "name": "BT Tower",
        ...
        "facilities": ["Event spaces", "High-speed internet", "24/7 access", "Dedicated server rooms", "Scenic views"],
    },
    {
        "id": 5,
        "name": "Centre Point",
        ...
        "facilities": ["Flexible office spaces", "Cafeteria", "Recreation areas", "Secure bike storage", "Nearby public transport"],
    },
    {
        "id": 6,
        ...
        "facilities": ["Quiet environment", "Cultural venue access", "Secure entry", "Dedicated parking", "Proximity to public transport"],
    },
    {
        "id": 7,
        "name": "One Canada Square",
        "coordinates": [-0.019880, 51.504731],
        ...
        "facilities": ["Cafeteria", "Conference halls", "Parking", "High-speed elevators", "Proximity to shopping areas"],
    },
    {
        "id": 8,
        "name": "10 Upper Bank Street",
        "coordinates": [-0.021180, 51.504751],
        ...
        "facilities": ["Rooftop terrace", "Gym", "Childcare services", "Flexible leases", "Proximity to public transport"],
    },
    {
        "id": 9,
        "name": "Westfield Stratford City Offices",
        "coordinates": [-0.005449, 51.543581],
        ...
        "facilities": ["Shopping center access", "Parking", "Event spaces", "High-speed internet", "On-site cafes"],
    },
    {
        "id": 10,
        "name": "Victoria House",
        "coordinates": [-0.119565, 51.518986],
        ...
        "facilities": ["Classic architecture", "Flexible layouts", "24/7 access", "On-site cafeteria", "Proximity to museums"],
    },
    {
      "id": 1,
      "name": "HSBC Holdings",
